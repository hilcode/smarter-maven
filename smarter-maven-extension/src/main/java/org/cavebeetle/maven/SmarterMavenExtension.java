 ...
 */
@Component(role = AbstractMavenLifecycleParticipant.class, hint = "smarter-maven-extension")
public final class SmarterMavenExtension extends AbstractMavenLifecycleParticipant {
